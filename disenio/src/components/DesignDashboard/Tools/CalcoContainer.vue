...
export default {
  ...
  computed: {
    ...
    isPresetTwo () {
      return !this.isCalcoFondo && !(this.calcoInfo.LVeta < 81 || this.calcoInfo.AVeta < 81)
    },
    isPresetThree () {
      return !this.isPresetTwo && this.calcoInfo.AVeta < 81 && this.calcoInfo.LVeta > 81
    },
    isPresetFour () {
      return !this.isPresetThree && this.calcoInfo.LVeta < 81
    },
    elementSelected () {
