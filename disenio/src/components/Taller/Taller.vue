                      ...
                      >
                        ...
                        <td>
                          <select
                            ...
                            @change="
                              onChangeMetadataMaterialEstado($event, materiales)
                            "
                          >
                      ...
                      <template v-for="(modulo, index) in cajonesFiltrados">
                        ...
                        >
                          ...
                          <td>  
                            <button
                              class="btn btn-primary"
                              @click="changeEstadoModulo(modulo, 3, true)"
                              type="button"
                            >
                              Armar
                            </button>
                    ...
                    <template v-for="(modulo, index) in proyectoInfo.modulos">
                      ...
                      >
                        ...
                        <td>
                          <button
                            class="btn btn-primary"
                            @click="changeEstadoModulo(modulo, 3, false)"
                            type="button"
                          >
                            Armar
                          </button>
  ...
  methods: {
   ...
   // async verHistorialTaller(etapa_id,  item){
    async verHistorialTaller(etapa_id, id, campo_id){
        console.log( `verHistorialTaller  Etapa: ${etapa_id}, campo_id :  ${campo_id}  `)
    ...
    */
    ...
    changeEstadoModulo(modulo, estado_id, esCajon) {
    ...
    async onChangeMetadataMaterialEstado(estado_id, material) {
      //let
