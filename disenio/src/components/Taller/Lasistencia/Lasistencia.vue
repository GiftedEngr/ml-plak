            ...
            <tr v-for="(asistencia, i) in asistencias" :class="{
              ...
              <td>
                <span v-if="asistencia.cert_medico==1 && asistencia.heading">
                  <button class="btn btn-sm btn-danger" :disabled="!(asistencia.heading && configMonth.status==0)" @click="showInasistencia(usuario.id,asistencia.fechaDia)" title="Actualizar/visualizar documento">
      ...
      <form @submit.prevent="agregarInasistencia" enctype="multipart/form-data">
          ...
          > 
            <div class="row">
              ...
              <div class="col-2">
                <button v-if="formInasistencia.id > 0" class="btn btn-sm btn-success"
          ...
          > 
            ...
            <div class="row">  
              <div class="col-12" >
                <input type="submit" class="btn btn-sm btn-primary" value="Guardar documento" style="float: right;">
              </div>
            </div>  
          </b-form-group>
      </form>
